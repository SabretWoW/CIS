...
class ShortLinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create short_link" do
    assert_difference("ShortLink.count") do
      post short_links_url, params: { short_link: { full_url: @short_link.full_url, short_link: @short_link.short_link } }
    end
  ...
  test "should update short_link" do
    patch short_link_url(@short_link), params: { short_link: { full_url: @short_link.full_url, short_link: @short_link.short_link } }
